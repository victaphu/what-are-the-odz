...
const NewChatForm = () => {
  ...
  const { setShowCreateGroupDlg } = useGroups();
  // const { convertedName } = useAuth();

  function lowerLetters(str: string) {
  ...
  return (
    <div>
      ...
      >
        <Typography className="chat-card-activity-time" style={{ flexGrow: '1' }}>
          My Groups
        </Typography>

        <PlusOutlined onClick={() => {
          setShowCreateGroupDlg(true);
          // if (conn.userName === "john%20doe") {
          //   alert("Adding conversations is disabled on sample account, sorry!");
          //   return
          // }
